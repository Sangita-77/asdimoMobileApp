...
import { Animated, Image, ImageBackground, Platform, Pressable, StyleSheet, View } from "react-native";
...
useEffect(() => {
  ...
  Asset.loadAsync([bgImg, demoImg, logoImg, playImg, settingsImg, CloseButton, RingImage]);
            ...
            <View style={styles.containerWrap}>                
                <View style={styles.gridItem}>
                  <View style={styles.mainDemo}>
                      <Image source={demoImg} style={styles.imageLogo} resizeMode="cover" />
                  </View>
                </View>
