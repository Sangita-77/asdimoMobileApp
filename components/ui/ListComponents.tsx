...
const styles = StyleSheet.create({
  ...
  dateBar: { flexDirection: "row", alignItems: "center", backgroundColor: "#EFF7FE", borderRadius: 4, minHeight: 40, paddingHorizontal: 6, paddingVertical: 2, marginTop: 8, },
  dateText: { flex: 1, color: "#1682E7", fontSize: 15, fontWeight: "600", marginLeft: 6, },
